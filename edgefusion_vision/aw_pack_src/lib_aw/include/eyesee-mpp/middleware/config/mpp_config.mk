...
CEDARX_EXT_CFLAGS += -DMPPCFG_COMPILE_STATIC_LIB
endif
ifeq ($(MPPCFG_COMPILE_DYNAMIC_LIB), Y)
CEDARX_EXT_CFLAGS += -DMPPCFG_COMPILE_DYNAMIC_LIB
endif
...
else ifeq ($(MPPCFG_CHIP), AW1882)
  CEDARX_EXT_CFLAGS += -DAWCHIP=0x1882#AW_V821
else ifeq ($(MPPCFG_CHIP), AW1931)
  CEDARX_EXT_CFLAGS += -DAWCHIP=0x1931#AW_V821B
else
...
ifeq ($(MPPCFG_SUPPORT_FASTBOOT_TDM_OFFLINE_HANDLE_RAW),Y)
  CEDARX_EXT_CFLAGS += -DMPPCFG_SUPPORT_FASTBOOT_TDM_OFFLINE_HANDLE_RAW=1
else
  CEDARX_EXT_CFLAGS += -DMPPCFG_SUPPORT_FASTBOOT_TDM_OFFLINE_HANDLE_RAW=0
endif
...
ifeq ($(MPPCFG_SOFTWARE_TDM_FOR_ISP),Y)
  CEDARX_EXT_CFLAGS += -DSOFTWARE_TDM_FOR_ISP
endif
...
ifeq ($(MPPCFG_VDECSOFT),Y)
  CEDARX_EXT_CFLAGS += -DMPPCFG_VDECSOFT=1#OPTION_VDECSOFT_ENABLE
else
  CEDARX_EXT_CFLAGS += -DMPPCFG_VDECSOFT=0#OPTION_VDECSOFT_DISABLE
endif
...
ifeq ($(MPPCFG_AIO_LIB),alsa)
  CEDARX_EXT_CFLAGS += -DMPPCFG_AIO_LIB=0#OPTION_AIO_LIBRARY_ALSA
endif
ifeq ($(MPPCFG_AIO_LIB),audiosystem)
  CEDARX_EXT_CFLAGS += -DMPPCFG_AIO_LIB=1#OPTION_AIO_LIBRARY_AUDIOSYSTEM
endif
...
ifeq ($(MPPCFG_AENC_OPUS),Y)
  CEDARX_EXT_CFLAGS += -DMPPCFG_AENC_OPUS=1
else
  CEDARX_EXT_CFLAGS += -DMPPCFG_AENC_OPUS=0
endif
...
ifeq ($(MPPCFG_PARSER_AAC),Y)
  CEDARX_EXT_CFLAGS += -DMPPCFG_PARSER_AAC=1
else
  CEDARX_EXT_CFLAGS += -DMPPCFG_PARSER_AAC=0
endif
ifeq ($(MPPCFG_PARSER_AMR),Y)
  CEDARX_EXT_CFLAGS += -DMPPCFG_PARSER_AMR=1
else
  CEDARX_EXT_CFLAGS += -DMPPCFG_PARSER_AMR=0
endif
ifeq ($(MPPCFG_PARSER_APE),Y)
  CEDARX_EXT_CFLAGS += -DMPPCFG_PARSER_APE=1
else
  CEDARX_EXT_CFLAGS += -DMPPCFG_PARSER_APE=0
endif
ifeq ($(MPPCFG_PARSER_FLAC),Y)
  CEDARX_EXT_CFLAGS += -DMPPCFG_PARSER_FLAC=1
else
  CEDARX_EXT_CFLAGS += -DMPPCFG_PARSER_FLAC=0
endif
ifeq ($(MPPCFG_PARSER_ID3V2),Y)
  CEDARX_EXT_CFLAGS += -DMPPCFG_PARSER_ID3V2=1
else
  CEDARX_EXT_CFLAGS += -DMPPCFG_PARSER_ID3V2=0
endif
ifeq ($(MPPCFG_PARSER_MOV),Y)
  CEDARX_EXT_CFLAGS += -DMPPCFG_PARSER_MOV=1
else
  CEDARX_EXT_CFLAGS += -DMPPCFG_PARSER_MOV=0
endif
ifeq ($(MPPCFG_PARSER_MP3),Y)
  CEDARX_EXT_CFLAGS += -DMPPCFG_PARSER_MP3=1
else
  CEDARX_EXT_CFLAGS += -DMPPCFG_PARSER_MP3=0
endif
ifeq ($(MPPCFG_PARSER_MPG),Y)
  CEDARX_EXT_CFLAGS += -DMPPCFG_PARSER_MPG=1
else
  CEDARX_EXT_CFLAGS += -DMPPCFG_PARSER_MPG=0
endif
ifeq ($(MPPCFG_PARSER_OGG),Y)
  CEDARX_EXT_CFLAGS += -DMPPCFG_PARSER_OGG=1
else
  CEDARX_EXT_CFLAGS += -DMPPCFG_PARSER_OGG=0
endif
ifeq ($(MPPCFG_PARSER_TS),Y)
  CEDARX_EXT_CFLAGS += -DMPPCFG_PARSER_TS=1
else
  CEDARX_EXT_CFLAGS += -DMPPCFG_PARSER_TS=0
endif
ifeq ($(MPPCFG_PARSER_WAV),Y)
  CEDARX_EXT_CFLAGS += -DMPPCFG_PARSER_WAV=1
else
  CEDARX_EXT_CFLAGS += -DMPPCFG_PARSER_WAV=0
endif

ifeq ($(MPPCFG_STREAM_HTTP),Y)
    CEDARX_EXT_CFLAGS += -DMPPCFG_STREAM_HTTP=1
else
    CEDARX_EXT_CFLAGS += -DMPPCFG_STREAM_HTTP=0
endif
ifeq ($(MPPCFG_STREAM_TCP),Y)
    CEDARX_EXT_CFLAGS += -DMPPCFG_STREAM_TCP=1
else
    CEDARX_EXT_CFLAGS += -DMPPCFG_STREAM_TCP=0
endif
...
ifeq ($(MPPCFG_AGC_LIB),webrtc)
  CEDARX_EXT_CFLAGS += -DMPPCFG_AGC_LIB=0#OPTION_AGC_LIBRARY_WEBRTC
endif
ifeq ($(MPPCFG_AGC_LIB),agcfloat)
  CEDARX_EXT_CFLAGS += -DMPPCFG_AGC_LIB=1#OPTION_AGC_LIBRARY_AGCFLOAT
endif
...
ifeq ($(MPPCFG_ANS_LIB),libwebrtc)
  CEDARX_EXT_CFLAGS += -DMPPCFG_ANS_LIB=0#OPTION_ANS_LIBRARY_WEBRTC, SELECT ANS LIBRARY FROM WEBRTC
endif

ifeq ($(MPPCFG_ANS_LIB),liblstm)
  CEDARX_EXT_CFLAGS += -DMPPCFG_ANS_LIB=1#OPTION_ANS_LIBRARY_LSTM, SELECT ANS LIBRARY FROM LSTM
endif

ifeq ($(MPPCFG_ANS_LIB),libnosc)
  CEDARX_EXT_CFLAGS += -DMPPCFG_ANS_LIB=2#OPTION_ANS_LIBRARY_NOSC, SELECT ANS LIBRARY NOSC
endif
...
ifeq ($(MPPCFG_USE_IOMMU),Y)
  CEDARX_EXT_CFLAGS += -DMPPCFG_USE_IOMMU=1
endif
