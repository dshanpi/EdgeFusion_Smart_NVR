...
typedef struct AIO_ATTR_S
{
    ...
    /**
      point num per frame (80/160/240/320/480/1024/2048), i.e. period_size,
        ...
        ai set and get, only support 160,320,960,1024. 0 means default value, now is 960.
        ao can't set now.
    */
...
typedef enum AudioDevEventType
{
    ...
    */
    ...
    /**
      send raw capture pcm data to user.
      pEventData = AUDIO_FRAME_S*
    */
    AudioDevEvent_RawCapData,
