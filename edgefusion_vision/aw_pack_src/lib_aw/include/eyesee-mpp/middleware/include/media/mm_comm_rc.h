...
typedef enum VENC_RC_MODE_E
{
	...
	VENC_RC_MODE_H264_AVBR,
	VENC_RC_MODE_H264_QVBR,
	VENC_RC_MODE_H264_CVBR,
	...
	VENC_RC_MODE_H265_AVBR,
	VENC_RC_MODE_H265_QVBR,
	VENC_RC_MODE_H265_CVBR,
...
typedef struct VENC_ATTR_H264_ABR_S
{
	...
	unsigned int      vbv_buf_delay;                        /* range:[1, 100]; */
}VENC_ATTR_H264_ABR_S;
typedef struct VENC_ATTR_H264_AVBR_S{
	unsigned int      mGop;
	unsigned int      mStatTime;                            /* the rate statistic time, the unit is senconds(s) */
	unsigned int      mSrcFrmRate;                          /* the input frame rate of the venc chnnel */
	unsigned int      mDstFrmRate;                          /* the target frame rate of the venc chnnel */
...
typedef struct VENC_ATTR_H264_CVBR_S{
	unsigned int      mGop;
	unsigned int      mStatTime;                            /* the rate statistic time, the unit is senconds(s) */
	unsigned int      mSrcFrmRate;                          /* the input frame rate of the venc chnnel */
	unsigned int      mDstFrmRate;                          /* the target frame rate of the venc chnnel */
	unsigned int      mMaxBitRate;                          /* the max bitrate */
} VENC_ATTR_H264_CVBR_S;

typedef struct VENC_ATTR_H264_QVBR_S{
	unsigned int      mGop;
	unsigned int      mStatTime;                            /* the rate statistic time, the unit is senconds(s) */
	unsigned int      mSrcFrmRate;                          /* the input frame rate of the venc chnnel */
	unsigned int      mDstFrmRate;                          /* the target frame rate of the venc chnnel */
	unsigned int      mTargetBitRate;                          /* the max bitrate */
...
typedef struct VENC_ATTR_H264_AVBR_S  VENC_ATTR_H265_AVBR_S;
typedef struct VENC_ATTR_H264_CVBR_S  VENC_ATTR_H265_CVBR_S;
typedef struct VENC_ATTR_H264_QVBR_S  VENC_ATTR_H265_QVBR_S;
...
typedef struct VENC_RC_ATTR_S
{
    ...
    union
    {
		...
		VENC_ATTR_H264_AVBR_S   mAttrH264Avbr;
		VENC_ATTR_H264_CVBR_S   mAttrH264Cvbr;
		VENC_ATTR_H264_QVBR_S   mAttrH264Qvbr;
		...
		VENC_ATTR_H265_AVBR_S   mAttrH265Avbr;
		VENC_ATTR_H265_CVBR_S   mAttrH265Cvbr;
		VENC_ATTR_H265_QVBR_S   mAttrH265Qvbr;
...
typedef struct VENC_PARAM_H264_ABR_S   VENC_PARAM_H265_ABR_S;
typedef struct VENC_PARAM_H264_AVBR_S  VENC_PARAM_H265_AVBR_S;
typedef struct VENC_PARAM_H264_CVBR_S  VENC_PARAM_H265_CVBR_S;
typedef struct VENC_PARAM_H264_QVBR_S  VENC_PARAM_H265_QVBR_S;
...
{     
    ...
    union   //judge by VENC_CHN_ATTR_S->mVeAttr->mType, VENC_CHN_ATTR_S->RcAttr->mRcMode
    {
		...
		VENC_PARAM_H264_ABR_S     ParamH264Abr;                 /*not support*/
		VENC_PARAM_H264_AVBR_S    ParamH264Avbr;                /*not support*/
		VENC_PARAM_H264_CVBR_S    ParamH264Cvbr;                /*not support*/
		VENC_PARAM_H264_QVBR_S    ParamH264Qvbr;                /*not support*/
		...
		VENC_PARAM_H265_ABR_S     ParamH265Abr;                 /*not support*/
		VENC_PARAM_H265_AVBR_S    ParamH265Avbr;                /*not support*/
		VENC_PARAM_H265_CVBR_S    ParamH265Cvbr;                /*not support*/
		VENC_PARAM_H265_QVBR_S    ParamH265Qvbr;                /*not support*/
