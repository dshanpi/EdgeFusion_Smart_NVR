...
char *AW_MPI_ISP_GetSensorName(ISP_DEV IspDev);
...
AW_S32 AW_MPI_ISP_SetMirror(ISP_DEV IspDev, int Value);
AW_S32 AW_MPI_ISP_SetFlip(ISP_DEV IspDev, int Value);
AW_S32 AW_MPI_ISP_GetMirror(ISP_DEV IspDev, int *Value);
AW_S32 AW_MPI_ISP_GetFlip(ISP_DEV IspDev, int *Value);
...
AW_S32 AW_MPI_ISP_GetIrAwbWinCntWeight(ISP_DEV IspDev);
