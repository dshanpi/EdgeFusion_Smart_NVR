...
ERRORTYPE AW_MPI_VENC_Pause(VENC_CHN VeChn);
...
ERRORTYPE AW_MPI_VENC_ResetOutStream(VENC_CHN VeChn);
ERRORTYPE AW_MPI_VENC_RequestIDR(VENC_CHN VeChn, int mode);
...
ERRORTYPE AW_MPI_VENC_SetIntraRefresh(VENC_CHN VeChn, VencCyclicIntraRefresh *pIntraRefresh);
ERRORTYPE AW_MPI_VENC_GetIntraRefresh(VENC_CHN VeChn, VencCyclicIntraRefresh *pIntraRefresh);
...
ERRORTYPE AW_MPI_VENC_Set3DFilter(VENC_CHN VeChn, const Venc3dFilterParam *p3DfilterParam);
ERRORTYPE AW_MPI_VENC_Get3DFilter(VENC_CHN VeChn, Venc3dFilterParam *p3DfilterParam);
...
ERRORTYPE AW_MPI_VENC_EnableOnlineTakePicture(VENC_CHN VeChn, BOOL bEnable);

ERRORTYPE AW_MPI_VENC_SetDirMvParam(VENC_CHN VeChn, const VencDirMvParam *pDirMvParam);
ERRORTYPE AW_MPI_VENC_GetDirMvInfoResult(VENC_CHN VeChn, VencDirMvInfoResult *pDirMvInfoResult);
