...
ERRORTYPE AW_MPI_VI_SetNextPtn(VI_DEV ViDev, VI_ATTR_S *pstAttr);
AW_S32 AW_MPI_VI_GetPtnFrameNum(VI_DEV ViDev);
...
ERRORTYPE AW_MPI_VI_GetViBufInfo(VI_DEV ViDev, const unsigned int buf_id, VI_BUFFER_INFO_S *pstInfo);
