...
#define AW_V821 0x1882
#define AW_V821B 0x1931
//AWCHIP will be defined in mpp_config.mk.
#ifndef AWCHIP
    #define AWCHIP AW_V821B
    #warning "app don't define AWCHIP, use default value: AW_V821B"
#endif
    ...
    #define MPP_VER_PRIX "_MPP_V"
#elif (AWCHIP==AW_V821)
    #define CHIP_NAME    "AWV821"
    #define MPP_VER_PRIX "_MPP_V"
#elif (AWCHIP==AW_V821B)
    #define CHIP_NAME    "AWV821B"
    #define MPP_VER_PRIX "_MPP_V"
#else
