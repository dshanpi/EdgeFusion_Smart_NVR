 ...
 *                             -1: error
 */
int32_t aw_WebRtcAec_Create(void** aecInst);
 ...
 *                             -1: error
 */
int32_t aw_WebRtcAec_Init(void* aecInst, int32_t sampFreq, int32_t scSampFreq);


int32_t aw_WebRtcAec_Free(void* aecInst);
 ...
 *                              -1: error
 */
int aw_WebRtcAec_set_config(void* handle, AecConfig config);
 ...
 *                             -1: error
 */
int32_t aw_WebRtcAec_BufferFarend(void* aecInst,
 ...
 *                             -1: error
 */
int32_t aw_WebRtcAec_Process(void* aecInst,
