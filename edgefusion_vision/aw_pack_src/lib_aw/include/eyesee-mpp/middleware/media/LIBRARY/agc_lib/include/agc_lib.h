 ...
 *                          : -1 - Error
 */
int aw_WebRtcAgc_Process(void* agcInst,
 ...
 *                          : -1 - Error
 */
int aw_WebRtcAgc_set_config(void* agcInst, WebRtcAgc_config_t config);
 ...
 *                          : -1 - Error
 */
int aw_WebRtcAgc_get_config(void* agcInst, WebRtcAgc_config_t* config);
 ...
 */
int aw_WebRtcAgc_Create(void **agcInst);
 ...
 *                            -1 - Error
 */
int aw_WebRtcAgc_Free(void *agcInst);
 ...
 *                            -1 - Error
 */
int aw_WebRtcAgc_Init(void *agcInst,
                   int32_t minLevel,
                   int32_t maxLevel,
                   int16_t agcMode,
                   uint32_t fs);
