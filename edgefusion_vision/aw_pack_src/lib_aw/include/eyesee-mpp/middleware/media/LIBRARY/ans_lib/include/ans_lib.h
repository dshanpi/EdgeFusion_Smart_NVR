 ...
 *                        -1 - Error
 */
int aw_WebRtcNs_Create(NsHandle** NS_inst);
 ...
 *                        -1 - Error
 */
int aw_WebRtcNs_Free(NsHandle* NS_inst);
 ...
 *                        -1 - Error
 */
int aw_WebRtcNs_Init(NsHandle* NS_inst, unsigned int fs);
 ...
 *                        -1 - Error
 */
int aw_WebRtcNs_set_policy(NsHandle* NS_inst, int mode);
 ...
 *                        -1 - Error
 */
int aw_WebRtcNs_Process(NsHandle* NS_inst,
                     short* spframe,
                     short* spframe_H,
                     short* outframe,
                     short* outframe_H);
 ...
 */
float aw_WebRtcNs_prior_speech_probability(NsHandle* handle);
