...
#if (MPPCFG_AIO_LIB == OPTION_AIO_LIBRARY_ALSA)
  #include <alsa_interface.h>
#elif(MPPCFG_AIO_LIB == OPTION_AIO_LIBRARY_AUDIOSYSTEM)
...
ERRORTYPE audioHw_AI_EnableSendCaptureFrame(AUDIO_DEV AudioDevId, BOOL bEnable);
