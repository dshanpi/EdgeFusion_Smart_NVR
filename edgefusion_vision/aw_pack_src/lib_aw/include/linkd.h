...
#define WMG_LINKD_PROTO_MAX     (13)
#define DEFAULT_SECOND          120

typedef void (*proto_result_cb)(wifi_linkd_result_t *linkd_result ,pthread_t thread_num);
...
typedef struct {
	...
	pthread_t thread;
	wmg_status_t (*linkd_init)(int wait_second, void *params);
