...
/* define for software tdm for isp */
#define ISP_LOAD_BUF_SIGN0        (0x1a)
#define ISP_LOAD_BUF_SIGN1        (0x1b)
#define ISP_LOAD_BUF_SIGN0_OFFSET (0)
#define ISP_LOAD_BUF_SIGN1_OFFSET (1)
#define ISP_SAVE_BUF_SIGN0        (0x2d)
#define ISP_SAVE_BUF_SIGN1        (0x2c)
#define ISP_SAVE_BUF_SIGN0_OFFSET (2)
#define ISP_SAVE_BUF_SIGN1_OFFSET (3)
#define SOFTWARE_TDM_ID           (1)
#define VIRT_ISP_ID               (2)
...
#define VIDIOC_VIN_SET_SOFTWARE_TDM_CHANGE \
