...
#define MAX_SUPPORT_MODE_NUM 16  /* use in support list */
...
typedef struct {
	char mode_name[10];
	mode_opt_t *mode_opt;
	wmg_status_t (*init)(wifi_msg_cb_t msg_cb, void *msg_cb_arg);
...
typedef struct {
	...
	uint8_t* wmg_mode_support_list;
	uint8_t* module_mode_support_list;

	wmg_status_t (*init)(void);
	void (*deinit)(void);
	wmg_status_t (*switch_mode)(wifi_mode_t, wmg_bool_t);
	...
	wmg_status_t (*monitor_enable)(wifi_monitor_config_t *);
	...
	wmg_status_t (*p2p_find)(int find_second, char *types);
	wmg_status_t (*p2p_get_peers)(wifi_p2p_peers_t *p2p_peers, uint32_t *p2p_num, uint32_t p2p_arr_size);
	...
	wmg_status_t (*send_expand_cmd)(char *expand_cmd, void *expand_params, void *expand_cb);
...
#define WMG_P2P_CMD_GET_PEERS           0x4
#define WMG_P2P_CMD_CONNECT             0x5
#define WMG_P2P_CMD_DISCONNECT          0x6
#define WMG_P2P_CMD_GET_INFO            0x7
#define WMG_P2P_CMD_REGISTER_MSG_CB     0x8
#define WMG_P2P_CMD_GET_STATE           0x9
...
#define WMG_P2P_ACT_GET_PEERS       0x3
#define WMG_P2P_ACT_CONNECT         0x4
#define WMG_P2P_ACT_DISCONNECT      0x5
#define WMG_P2P_ACT_GET_INFO        0x6
...
int __wifi_p2p_get_peers(void **call_argv,void **cb_argv);
